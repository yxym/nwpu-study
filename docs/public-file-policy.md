...
本人自愿公开的课程作业、实验报告、原始数据可以包含姓名、学号或小组信息；贡献前应确认自己接受公开，并避免夹带与课程产出无关的第三方隐私。
...
- 未经许可的第三方个人信息、名单或花名册、成绩表、联系方式、证件号、邮箱、住址等隐私或敏感资料
...
`--check` 会检查完整白名单课程目录，迁移阶段可能报告仓库中的历史遗留文件。新增贡献不应引入新的排除项；如果错误涉及本次新增或修改路径，请先修正。若输出只涉及既有历史问题，请在 PR 中说明，维护者会逐步清理。
